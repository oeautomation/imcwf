...
const styles = {
  ...
  headerRow: (sticky) => mergeStyles({ display: "grid", gridTemplateColumns: "80px 90px 110px 1fr 110px 140px 110px 100px 90px 70px", alignItems: "center", borderBottom: "1px solid #e2e8f0", background: "#fff", fontSize: 12, fontWeight: 600, color: "#475569" }, sticky && { position: "sticky", top: 0, zIndex: 10 }),
  cell: { padding: "8px 8px" },
  row: { display: "grid", gridTemplateColumns: "80px 90px 110px 1fr 110px 140px 110px 100px 90px 70px", alignItems: "center", fontSize: 14 },
  ...
  return (
    <div style={{ borderBottom: "1px solid #e2e8f0" }}>
      <div style={styles.row}>
        ...
        <div style={styles.cell}>{row.qc ? <span style={{ fontSize: 12 }}>{row.qc}</span> : <span style={mergeStyles(styles.muted, { fontSize: 12 })}>—</span>}</div>
    ...
    <div style={styles.container}>
      <div style={styles.topbar}>
        <div style={styles.topbarLeft}>
          <div style={styles.title}>Enter Data</div>
        ...
        <div style={styles.topbarRight}>
          ...
          <Button onClick={() => alert("Saved run\n" + JSON.stringify(rows, null, 2))}>Submit</Button>
        </div>
      </div>
